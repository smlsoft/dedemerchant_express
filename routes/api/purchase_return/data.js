...
const dataresult = async (token, search,fromdate, todate,) => {
  ...
  try {
    ...
    const data = db.collection("transactionPurchaseReturn");
...
const genDownLoadPurchaseReturnPDF = async (token, search, fromdate, todate, fileName) => {
...
module.exports = { dataresult, genPDF, pdfPreview, pdfDownload, sendEmail , genDownLoadPurchaseReturnPDF};
