...
const dataresult = async (token, year, month) => {
  ...
  try {
    ...
    const transactionPaid = db.collection("transactionPurchase");
...
const genDownLoadVatPurchasePDF = async (token, year, month, fileName) => {
...
module.exports = { dataresult, genPDF, pdfPreview, pdfDownload , genDownLoadVatPurchasePDF };
