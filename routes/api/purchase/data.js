...
const dataresult = async (token, search, fromdate, todate,) => {
  ...
  try {
    ...
    const data = db.collection("transactionPurchase");
...
const genDownLoadPurchasePDF = async (token, search, fromdate, todate, fileName) => {
...
module.exports = { dataresult, genPDF, pdfPreview, pdfDownload, sendEmail , genDownLoadPurchasePDF };
