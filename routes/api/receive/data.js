...
const genDownLoadReceivePDF = async (token, search, fromdate, todate, fileName) => {
...
module.exports = { dataresult, genPDF, pdfPreview, pdfDownload, sendEmail , genDownLoadReceivePDF };
